			   	...
			   	<li style="background-image: url(images/g.jpg);">
			   		...
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1 style="color: #FE0000">We Mould Students To Practical Economy</h1>
				   					<p><a href="#" class="btn btn-primary btn-lg btn-learn">Check In</a></p>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			   	...
			   	<li style="background-image: url(images/d.jpg);">
			   		...
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1 style="color: #FE0000">Center Of Academic Excellenece</h1>
				   					<p><a href="#" class="btn btn-primary btn-lg btn-learn">Enroll Today</a></p>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
					...
					<div class="col-md-4 intro-wrap">
						<div class="intro-flex">
							...
							<div class="one-third color-3 animate-box">
								<div class="desc2">
									<h3>We Offer Free Accomodation for Students</h3>
									<p><a href="#" class="view-more">View More</a></p>
								</div>
							</div>
						</div>
							...
							<div class="col-md-3 col-sm-6 animate-box">
								<div class="counter-entry">
									...
									<div class="desc">
										...
										<span class="colorlib-counter-label">School Management</span>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-3 animate-box">
						<div class="trainers-entry">
							...
							<div class="desc">
								<h3>SCOVIA NELLY</h3>
								<span>Chaiman of Department</span>
							</div>
						</div>
					</div>
					...
					<div class="half">
						<div class="row">
							...
							<div class="col-md-12 animate-box">
								<div class="event-entry">
									<div class="desc">
										<p class="meta"><span class="day">15</span><span class="month">Feb</span></p>
										<p class="organizer"><span>Organized by:</span> <span>Mrs.SARAH NYABOKE</span></p>
										<h2><a href="event.html">County Music Festival</a></h2>
									</div>
									<div class="location">
										<span class="icon"><i class="icon-map"></i></span>
